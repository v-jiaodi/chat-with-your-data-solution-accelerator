      ...
      containers: [
        {
          ...
          { name: 'AZURE_BLOB_ACCOUNT_KEY', value: storage.listKeys().keys[0].value}
          { name: 'AZURE_CONTENT_SAFETY_KEY', value: listKeys('Microsoft.CognitiveServices/accounts/${ContentSafetyName}', '2023-05-01').key1}
          { name: 'OPENAI_API_KEY', value: listKeys('Microsoft.CognitiveServices/accounts/${openAiName}', '2023-05-01').key1}
